...
export class Backend implements backendInterface {
    ...
    async generatePins(arg0: string): Promise<PinterestPinContent> {
        if (this.processError) {
            try {
                const result = await this.actor.generatePins(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllGeneratedPins(): Promise<Array<PinterestPinContent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllGeneratedPins();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGeneratedPinsByUrl(arg0: string): Promise<PinterestPinContent> {
        if (this.processError) {
            try {
                const result = await this.actor.getGeneratedPinsByUrl(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
